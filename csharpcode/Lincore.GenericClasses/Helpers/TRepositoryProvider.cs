...
namespace Lincore.GenericClasses.Helpers
{
    public class TRepositoryProvider : IRepositoryProvider
    {
        ...
        private TRepositoryFactories _repositoryFactories;
        protected Dictionary<Type, object> Repositories { get; private set; }

        public TRepositoryProvider(TRepositoryFactories repositoryFactories)
        {
        ...
        protected virtual T MakeRepository<T>(Func<DbContext, object> factory, DbContext dbContext)
        {
            ...
            if (f == null)
            {
                throw new NotImplementedException("Factory Not available for Type, " + typeof(T).FullName);
            }
